...
handlers._users.post = function (data, callback) {
  ...
  let lastName =
    typeof data.payload.lastName == 'string' && data.payload.lastName.trim().length > 0
      ...
      : false
  let phone =
    typeof data.payload.phone == 'string' && data.payload.phone.trim().length > 6 ? data.payload.phone.trim() : false
  let password =
...
handlers._users.get = function (data, callback) {
  ...
  let phone =
    typeof data.queryStringObject.phone == 'string' && data.queryStringObject.phone.trim().length > 6
...
handlers._checks = {}
// checks -post
// Required data: protocol, url, methods, successCodes, timeouts Seconds
// Optional data: none
